...
namespace quanlyphongkhamnhi.Services
{
    public class HoSoService
    {
            ...
            out string thongBaoLoi)
        {
            ...
            // 5.1 Kiểm tra giá trị hợp lệ cho giới tính
            if (!string.Equals(gioiTinhBenhNhan, "Nam", StringComparison.OrdinalIgnoreCase) &&
                !string.Equals(gioiTinhBenhNhan, "Nữ", StringComparison.OrdinalIgnoreCase))
            {
                thongBaoLoi = "Giới tính không hợp lệ";
                return false;
            }
            ...
            if (!string.Equals(gioiTinhBenhNhan, "Nam", StringComparison.OrdinalIgnoreCase) &&
                !string.Equals(gioiTinhBenhNhan, "Nữ", StringComparison.OrdinalIgnoreCase))
            {
                thongBaoLoi = "Giới tính bệnh nhân không hợp lệ";
                return false;
            }
