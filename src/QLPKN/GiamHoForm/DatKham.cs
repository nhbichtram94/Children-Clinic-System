        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("TaoPhieuKham", conn);
                    ...
                    int newPhieuKhamID = Convert.ToInt32(cmd.ExecuteScalar());
                    MessageBox.Show("Tạo phiếu khám thành công! Mã phiếu khám: " + newPhieuKhamID);
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Lỗi khi tạo phiếu khám: " + ex.Message);
                }
            }
        }
    }
